...
/**
 * Preferences manager class with default value
 *
...
public class PreferenceHelper {
    ...
    public static String getDeviceId(final Context context) {
        String deviceId = getPreferences(context).getString(CONFIG_DEVICE_ID, "");
        if (deviceId.isEmpty()) {
            deviceId = Utils.getUUID();
            getPreferencesEditor(context).putString(CONFIG_DEVICE_ID, deviceId).apply();
        }
        return deviceId;
    }
    ...
    /**
     * Get last neutral answer date (remind later)
     */
    ...
    /**
     * Set neutral answer (remind later)
     */
